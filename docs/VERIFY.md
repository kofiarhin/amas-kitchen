...
- Guest checkout and confirmation using an isolated database and test Telegram bot/chat.
...
Deployment verification additionally includes `/health`, production credentialed CORS/cookies, Telegram failure logging, provider backup policy, and a documented restore drill.
