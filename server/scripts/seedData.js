...
const zones = ["Hackney", "Stratford", "Leyton", "Walthamstow"].map((name, index) => ({ name, normalizedName: name.toLowerCase(), active: true, sortOrder: index + 1 }));
const settings = { key: "restaurant", orderingEnabled: true, minimumOrder: 2000, supportPhone: "020 7946 0182", supportEmail: "hello@amaskitchen.co.uk", closureReason: "" };
